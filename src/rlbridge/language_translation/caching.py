...
::
    ...
    from rlbridge.language_translation import SailingLanguageTranslator
    from rlbridge.language_translation.caching import CachingTranslator
...
def clear_translation_cache(env_id: str | None = None) -> None:
    ...
    ::
        ...
        from rlbridge.language_translation.caching import clear_translation_cache
