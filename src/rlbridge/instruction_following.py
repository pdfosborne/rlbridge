...
2. **Language translation** - each raw observation is passed through a
   :class:`~rlbridge.language_translation.LanguageTranslator` to produce a
...
::
    ...
    from rlbridge.instruction_following import build_sequential_instruction_following_protocol
...
def clear_obs_cache(env_id: str | None = None) -> None:
    ...
    ::
        ...
        from rlbridge.instruction_following import clear_obs_cache
...
def obs_cache_langs(env_id: str) -> list[str]:
    ...
    ::
        ...
        from rlbridge.instruction_following import obs_cache_langs
...
def match_instruction(
    ...
    *,
    ...
    encoder:
        ...
        :class:`~rlbridge.instruction_matching.BaseEncoder` interface.
        Defaults to sentence-transformers (``all-MiniLM-L6-v2``) when *None*.
        Pass :class:`~rlbridge.instruction_matching.TFIDFEncoder` to disable
        semantic re-ranking and use TF-IDF only.
    refine_top_k:
        Number of TF-IDF top candidates to re-score with the refine encoder.
    translator:
        :class:`~rlbridge.language_translation.LanguageTranslator` to convert
    ...
    exploration_protocol:
        ...
        :class:`~rlbridge.interaction_protocols.RandomEpisodeProtocol` with
    ...
    feedback_layer:
        Optional :class:`~rlbridge.instruction_matching.FeedbackLayer` used to
    ...
    if translator is None:
        if not use_raw_observations:
            raise ValueError(
                ...
                "rlbridge.language_translation.TRANSLATORS, or set "
...
def train_and_derive_instructions(
    ...
    **train_kwargs:
    ...
    ::
        ...
        from rlbridge import TabularQAgent
        from rlbridge.instruction_following import (
...
def list_instruction_cache(
    ...
    ::
        ...
        from rlbridge.instruction_following import list_instruction_cache
...
def state_instruction_map(
    ...
    ::
        ...
        from rlbridge.instruction_following import state_instruction_map
