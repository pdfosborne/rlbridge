...
::
    ...
    from rlbridge.environments.predefined.sailing import SailingFactory, SAILING_V0
...
---------------------
Works with :class:`~rlbridge.interaction_protocols.InstructionFollowingProtocol`
