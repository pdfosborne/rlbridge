...
Available agents
----------------
- :class:`~rlbridge.agents.tabular_q.TabularQAgent`   - tabular Q-learning (ε-greedy)
- :class:`~rlbridge.agents.dqn.DQNAgent`              - deep Q-network (NumPy, no framework dep)
- :class:`~rlbridge.agents.ppo.PPOAgent`              - proximal policy optimisation (NumPy)
...
::
    ...
    from rlbridge.environments.predefined.sailing import SAILING_V0
    from rlbridge.rl_agents import TabularQAgent, DQNAgent, PPOAgent
