...
natural-language descriptions via :mod:`rlbridge.language_translation`.

    translate=True          - auto-lookup translator for the environment
    translate=False / None  - no translation (default)
    translate=<translator>  - use a specific :class:`~rlbridge.language_translation.LanguageTranslator`
...
Example
-------
    from rlbridge.interaction_protocols import RandomEpisodeProtocol
...
class _BaseProtocol:
    ...
    def _get_effective_translator(
        ...
        :class:`~rlbridge.language_translation.generator.GeneratedTranslator` when
        *llm_fn* is provided.
...
class InstructionFollowingProtocol(_BaseProtocol):
    ...
    :func:`~rlbridge.instruction_following.match_instruction`, this protocol
    ...
    sub_goal_languages:
        ...
        when using :func:`~rlbridge.instruction_following.build_sequential_instruction_following_protocol`.
    policy_fn:
