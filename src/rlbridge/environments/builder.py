...
* **Language translation** - attach a named, custom, or LLM-generated
  :class:`~rlbridge.language_translation.base.LanguageTranslator`.  Generated
...
::
    ...
    from rlbridge.environments.builder import EnvironmentBuilder
...
::
    ...
    from rlbridge.environments.builder import BuiltEnvironment
...
::
    ...
    from rlbridge.environments.builder import load_cached_environments
...
class BuiltEnvironment:
    ...
    def register(
        ...
        *,
        ...
        ----------
        reg:
            :class:`~rlbridge.environments.registry.EnvironmentRegistry` to
...
class EnvironmentBuilder:
    ...
    def with_translator(
        ...
        ----------
        translator:
            Either a :class:`~rlbridge.language_translation.base.LanguageTranslator`
